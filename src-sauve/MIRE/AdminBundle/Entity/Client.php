 ...
 * Client
 *
 * @ORM\Table(name="mire_client")
 * @ORM\Entity(repositoryClass="MIRE\AdminBundle\Repository\ClientRepository")
 */
class Client
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="mobile", type="string", length=250, nullable=true)
     */
    private $mobile;
