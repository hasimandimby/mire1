...
class DefaultController extends Controller
{
    ...
    public function block1Action()
    {
        ...
        $articlesblock1 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(2);
        $categorieblock1 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>2));
        $articlesblock1big = new Article();
        if(count($articlesblock1) > 0)
        $articlesblock1big = $em->getRepository("MIREAdminBundle:Article")->findByPlaceLast(2);
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $articlesblock3 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(4);
        $categorieblock3 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>4));
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $articlesblock4 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(5);
        $categorieblock4 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>5));
        $articlesblock4big = new Article();
        if(count($articlesblock4) > 0)
        $articlesblock4big = $em->getRepository("MIREAdminBundle:Article")->findByPlaceLast(5);
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $articlesblock5 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(6);
        $categorieblock5 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>6));
        $articlesblock5big = new Article();
        if(count($articlesblock5) > 0)
        $articlesblock5big = $em->getRepository("MIREAdminBundle:Article")->findByPlaceLast(6);
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $articlesblock6 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(7);
        $categorieblock6 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>7));
        $articlesblock6big = new Article();
        if(count($articlesblock6) > 0)
        $articlesblock6big = $em->getRepository("MIREAdminBundle:Article")->findByPlaceLast(7);
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $articlesblock7 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(8);
        $categorieblock7 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>8));
        $articlesblock7big = new Article();

        if(count($articlesblock7) > 0)
        $articlesblock7big = $em->getRepository("MIREAdminBundle:Article")->findByPlaceLast(8);
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $articlesblock8 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(9);
        $categorieblock8 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>9));
        $articlesblock8big = new Article();
        if(count($articlesblock8) > 0)
        $articlesblock8big = $em->getRepository("MIREAdminBundle:Article")->findByPlaceLast(9);
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $articlesblock9 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(10);
        $categorieblock9 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>10));
        $articlesblock9big = new Article();
        if(count($articlesblock9) > 0)
        $articlesblock9big = $em->getRepository("MIREAdminBundle:Article")->findByPlaceLast(10);
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $articlesblock10 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(11);
        $categorieblock10 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>11));
        $articlesblock10big = new Article();
        if(count($articlesblock10) > 0)
        $articlesblock10big = $em->getRepository("MIREAdminBundle:Article")->findByPlaceLast(11);
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $articlesblock11 = $em->getRepository("MIREAdminBundle:Article")->findByPlace(12);
        $categorieblock11 = $em->getRepository("MIREAdminBundle:Categories")->findBy(array("place"=>12));
        $articlesblock11big = new Article();
        if(count($articlesblock11) > 0)
            $articlesblock11big = $em->getRepository("MIREAdminBundle:Article")->findByPlaceLast(12);
